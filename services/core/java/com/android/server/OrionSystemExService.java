...
import com.android.internal.util.orion.FullscreenTaskStackChangeListener;
...
public class OrionSystemExService extends SystemService {

    private static final String TAG = "OrionSystemExService";
    ...
    public OrionSystemExService(Context context) {
        super(context);
    ...
    private void maybeCleanClonedUser(int userId) {
        ...
        if (!hasUserApp) {
            ...
            orionUtils.forceStopDefaultLauncher(getContext());
        }
    }
    ...
    private final class PackageRemovedListener extends LauncherApps.Callback {
        ...
        public void onPackageRemoved(String packageName, UserHandle user) {
            ...
            OrionSystemExService.this.onPackageRemoved(packageName);
        }
