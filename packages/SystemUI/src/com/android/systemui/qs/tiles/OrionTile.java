...
public class OrionTile extends QSTileImpl<State> {
    ...
    private static final String ORION_PKG_NAME = "com.android.settings";
    private static final String OTA_PKG_NAME = "org.lineageos.updater";

    private static final Intent ORION_INTENT = new Intent()
            .setComponent(new ComponentName(ORION_PKG_NAME,
                "com.android.settings.Settings$OrionCustomizationsActivity"));
