...
import com.android.systemui.qs.tiles.OrionTile
...
interface LineageModule {
    ...
    /** Inject OrionTile into tileMap in QSModule */
    @Binds
    @IntoMap
    @StringKey(OrionTile.TILE_SPEC)
    fun bindOrionTile(OrionTile: OrionTile): QSTileImpl<*>
